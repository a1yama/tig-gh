...
func (r *PullRequestRepositoryImpl) ListComments(ctx context.Context, owner, repo string, number int, opts *models.CommentOptions) ([]*models.Comment, error) {
	// デフォルトオプション
	...
	// Note: PRのコメントもIssues.ListCommentsを使用する（GitHub APIの仕様）
